$(document).on('page:change', function() {
  if ($('#document-editor-toolbar').length) {
    SendMe.initSaving();
    SendMe.initKeyHandlers();
    SendMe.initToolbar();
    SendMe.initCursor();
    SendMe.initDocument();
    SendMe.initMouseHandlers();
    SendMe.initHighlighting();
  }
});
...
(function(SendMe) {
  ...
  // Public
  SendMe.initSaving = function() {
    // set up variables needed to save documents to the api
    document_url = $('#document-editor-toolbar').data().url;
    timer = null;
  };

  // Public
  SendMe.initKeyHandlers = function() {
  ...
  // Public
  SendMe.initMouseHandlers = function() {
  ...
  // Public
  SendMe.initHighlighting = function() {
  ...
  function saveChanges() {
    ...
    timer = setTimeout(updateDocument, 1500);
  }
